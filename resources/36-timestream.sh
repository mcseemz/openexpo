...
# @file 36-timestream.sh
# @brief Create or Update timestream infra for execution statistics
# @description
#
#   prerequesites:
#
...
# nothing here, no lambdas

#========================================================
STACKNAME=tex-timestream-$1
CHANGESETNAME=tex-timestream-update-$1
PARAMETERS=parameters-timestream-$1.json
TEMPLATE=cf-timestream.yaml
