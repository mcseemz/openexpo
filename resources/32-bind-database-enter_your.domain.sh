...
# @file 32-bind-database-to-domain.sh
...
#========================================================
STACKNAME=tex-bind-database-enter_your.domain-$1
CHANGESETNAME=tex-bind-database-enter_your.domain-update-$1
PARAMETERS=parameters-bind-database-enter_your.domain-$1.json
