...
# @file 60-cognito.sh
# @brief Create or Update userpools and user configurations
# @description
#
#   prerequesites:
#
...
mkdir ../lambdas/Cognito/model
cp ../lambdas/API/model/* ../lambdas/Cognito/model
...
#========================================================
STACKNAME=tex-cognito-ses-$1
CHANGESETNAME=tex-cognito-update-$1
PARAMETERS=parameters-cognito-$1.json
TEMPLATE=cf-cognito.yaml
